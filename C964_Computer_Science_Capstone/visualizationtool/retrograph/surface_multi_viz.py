...
from problemspace.surfacefunctions import (
    rastrigin_func,
    rosenbrock_func,
    ackley_func,
    himmelblau_func,
...
class SurfaceMultiViz(ThreeDScene):
    ...
    def construct(self):
        ...
        rosenbrock_raw = lambda u, v: rosenbrock_func(u, v, scale=0.01)
        ...
        ackley_raw = lambda u, v: ackley_func(u, v, scale=0.1)
        ...
        himmelblau_raw = lambda u, v: himmelblau_func(u, v, scale=0.01)
