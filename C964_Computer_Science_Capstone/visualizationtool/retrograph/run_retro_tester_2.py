...
Usage (from project root):
    python visualizationtool/run_retro_tester_2.py
"""
...
def main():
    # Get the package directory and project root (parent of visualizationtool)
    ...
    with _live_context("Starting...") as live:
        ...
        scene_file = "visualizationtool/retro_tester_2.py"
