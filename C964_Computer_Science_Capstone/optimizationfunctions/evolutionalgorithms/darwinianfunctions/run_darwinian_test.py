#!/usr/bin/env python3
"""
Script to run the Darwinian Functions test scene from the package.

Usage (from project root):
    python darwinian_functions/run_darwinian_test.py
"""
...
def main():
    ...
    scene_file = "darwinian_functions/core.py"
    scene_file_path = project_root / scene_file
    scene_class = "TestPureDarwinianFunction"
    output_name = f"MyDarwinian_v{version}"
    ...
    current_path = images_dir / "MyDarwinian_current.png"
    previous_path = images_dir / "MyDarwinian_previous.png"
