...
config is built via build_config_for_scene(scene, config_overrides) from the retro_configuration package.
"""
...
# Import utilities from retro_configuration module (same package)
