...
create_standard_3d_axes), and get_default_class_config(). Graph building (create_back_style_graph, animate_back_style_graph, create_contour_lines, write_contour_svg) lives in retro_back_graph and is re-exported here.
and get_default_class_config(). Use::

  from retro_configuration import get_scene_configuration, scene_config_overrides, build_config_for_scene
...
# Support both package import (retro_manim_graph.retro_configuration) and flat path (retro_manim_graph on sys.path).
try:
