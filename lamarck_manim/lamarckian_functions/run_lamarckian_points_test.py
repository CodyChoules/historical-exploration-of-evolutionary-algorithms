#!/usr/bin/env python3
"""
Script to run the point-only Lamarckian test scene.

Usage (from project root):
    python lamarckian_functions/run_lamarckian_points_test.py
"""
...
def main():
    ...
    version_file = script_dir / ".version_points"
    ...
    scene_file = "lamarckian_functions/lamarckian_points_display.py"
    scene_file_path = project_root / scene_file
    scene_class = "TestPureLamarckianPoints"
    output_name = f"MyLamarckianPoints_v{version}"
    ...
    current_path = images_dir / "MyLamarckianPoints_current.png"
    previous_path = images_dir / "MyLamarckianPoints_previous.png"
