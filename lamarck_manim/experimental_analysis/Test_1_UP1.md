...
| `parent1_start`, `parent1_end`, `parent2_start`, `parent2_end` | No      | Fixed by UP1: from shared 4 random points.                           |
...
| `population_size`           | No      | Fixed to 4 in UP1 to match 4 initial points.                              |
...
| `initial_population`        | No      | Fixed by UP1: same 4 points as Lamarckian.                                |
